    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4 ms-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                Gestion des barèmes appliqués aux opérations de retrait.
            </p>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-header bg-white border-0 pt-4 px-4">
                ...
                <p class="text-muted small mb-0">
                    Définissez l’intervalle de retrait et les frais correspondants.
                </p>
            ...
            <div class="card-body p-4">
                ...
                <form
                    action="<?= site_url('operateur/frais/retrait/ajouter') ?>"
                    method="post"
                >
                                        ...
                                        <td class="text-end pe-4">
                                            ...
                                            <div class="d-inline-flex gap-2">
                                                ...
                                                <?php if ((int) $bareme['actif'] === 1): ?>
                                                    ...
                                                    <form
                                                        action="<?= site_url(
                                                            'operateur/frais/retrait/desactiver/'
                                                            . $bareme['id']
                                                        ) ?>"
                                                        method="post"
                                                    >
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <form
                                                        action="<?= site_url(
                                                            'operateur/frais/retrait/activer/'
                                                            . $bareme['id']
                                                        ) ?>"
                                                        method="post"
                                                    >
                                                ...
                                                <form
                                                    action="<?= site_url(
                                                        'operateur/frais/retrait/supprimer/'
                                                        . $bareme['id']
                                                    ) ?>"
                                                    method="post"
                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p class="text-muted mt-3 mb-0">
                                            Aucun barème de retrait enregistré.
                                        </p>
